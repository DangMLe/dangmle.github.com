<?php
  ...
  $query = "insert into trainee(fName, lName, email, phone, grpfit, prtrain, nutr, questions, reference) values ('$fName', '$lName', '$email', '$phone', '$grpfit', '$prtrain', '$nutr', '$questions', '$reference')";
